...
async function updateBarangATK() {
    try {
        ...
        const { error } = await supabase.from('barang').update({
            ...
            id_kategori: barangATK.id_kategori,
                        ...
                        <div class="card shadow rounded-4 m-5">
                            <form @submit.prevent="updateBarangATK" class="m-5">
                                <div class="mb-3">
                                    ...
                                    <input :disabled="!barangATK.id_kategori" @change="imgPicked" type="file" accept="image/*">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select v-model="barangATK.kategori" @change="cekKategori" :key="barangATK.id_kategori" class="form-control form-select" id="keperluan">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input v-model="barangATK.jumlah" type="number" class="form-control"  aria-describedby="emailHelp">
                                </div>
