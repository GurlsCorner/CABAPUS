...
useHead({ title: "Edit Barang ART - CABAPUS" })
                        ...
                        <div class="card shadow rounded-4 m-5">
                            <form @submit.prevent="updateBarangATK" class="m-5">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input v-model="barangART.spek" type="text" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Kategori</label>
                                    <select v-model="barangART.id_kategori"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input v-model="barangART.jumlah" type="number" class="form-control"
                                        aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Satuan</label>
                                    <select v-model="barangART.id_satuan"
                                        class="form-control form-select" id="keperluan">
